...
import { FilenameSelectedOption } from '@/components/DatasetFiltering/GenericFilter/Common'
...
it('when image filename option, matches snapshot', () => {
  ...
  const wrapper = shallowMount(FilenameSelectedOption, { localVue, propsData })
