...
import BorderOpacityManipulator from '@/components/WorkView/ImageManipulation/Manipulators/BorderOpacityManipulator.vue'
...
it('matches snapshot', () => {
  const wrapper = shallowMount(BorderOpacityManipulator, { localVue, propsData: { editor }, stubs })
