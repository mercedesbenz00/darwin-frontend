...
import ImageBrightnessManipulator from '@/components/WorkView/ImageManipulation/Manipulators/ImageBrightnessManipulator.vue'
...
it('matches snapshot', () => {
  const wrapper = shallowMount(ImageBrightnessManipulator, { localVue, propsData: { editor }, stubs })
