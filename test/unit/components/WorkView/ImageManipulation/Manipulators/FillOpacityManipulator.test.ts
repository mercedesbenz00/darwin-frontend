...
import FillOpacityManipulator from '@/components/WorkView/ImageManipulation/Manipulators/FillOpacityManipulator.vue'
...
it('matches snapshot', () => {
  const wrapper = shallowMount(FillOpacityManipulator, { localVue, propsData: { editor }, stubs })
