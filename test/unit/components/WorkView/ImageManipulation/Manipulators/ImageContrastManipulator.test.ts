...
import ImageContrastManipulator from '@/components/WorkView/ImageManipulation/Manipulators/ImageContrastManipulator.vue'
...
it('matches snapshot', () => {
  const wrapper = shallowMount(ImageContrastManipulator, { localVue, propsData: { editor }, stubs })
