...
const ACTION = 'workview/loadDatasetItemCountsThrottled'
const BASE_ACTION = 'workview/loadDatasetItemCounts'
...
it('delegates to base action', async () => {
  ...
  expect(store.dispatch).toHaveBeenCalledWith(BASE_ACTION, undefined)
})
