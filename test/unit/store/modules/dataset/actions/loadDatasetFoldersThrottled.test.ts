...
const ACTION = 'dataset/loadDatasetFoldersThrottled'
const BASE_ACTION = 'dataset/loadDatasetFolders'

const payload: StoreActionPayload<typeof loadDatasetFolders> = {
  datasetId: 1
}
