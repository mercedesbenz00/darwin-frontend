...
import { SharedToolState, ToolContext } from '@/engineV2/managers'
import { FeatureFlagsManager } from '@/engineV2/managers/featureFlagsManager'
import { isModifierPressed } from '@/engineV2/utils'
 ...
 */
export const setupPrimaryButtonPanning = (
  context: ToolContext,
...
export const setupWASDPanning = (context: ToolContext): void => {
  ...
  const performScroll = (event: KeyboardEvent): void => {
    ...
    context.editor.activeView.camera.scroll(deltaPoint)
