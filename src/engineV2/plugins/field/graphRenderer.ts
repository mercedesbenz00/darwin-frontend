  ...
  render (
    ...
    for (const node of nodes) {
      ...
      if (nodeAnnotation.boundingBox && nodeAnnotation.text) {
        ...
        const nodeAnnotatonBBoxPath = nodeAnnotation.boundingBox
        ...
        if (FeatureFlagsManager.isOnLayerV2) {
          drawPathV2(
            ...
            {
              path: [
                nodeAnnotatonBBoxPath.topLeft,
                nodeAnnotatonBBoxPath.topRight,
                nodeAnnotatonBBoxPath.bottomRight,
                nodeAnnotatonBBoxPath.bottomLeft
              ],
              additionalPaths: []
            },
            view.camera,
