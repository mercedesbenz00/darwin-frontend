...
import ManipulatorDoubleSlider from '@/components/WorkView/ImageManipulation/Manipulators/components/ManipulatorDoubleSlider.vue'
...
it('matches the snapshot', () => {
  ...
  const wrapper = shallowMount(ManipulatorDoubleSlider, { localVue, mocks, propsData, stubs })
