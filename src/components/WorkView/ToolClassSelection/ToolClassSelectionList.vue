...
import ToolClassSelectionCreateItem from './ToolClassSelectionCreateItem.vue'
import ToolClassSelectionItem from './ToolClassSelectionItem.vue'
...
export default class ToolClassSelectionList extends Vue {
  ...
  onSelect (annotationClassPayload: AnnotationClassPayload): void {
    ...
    if (currentTool && currentTool.name === 'edit_tool') {
      ...
      const changed = this.editor.maybeChangeSelectedAnnotationClass(annotationClass)
      if (changed) {
