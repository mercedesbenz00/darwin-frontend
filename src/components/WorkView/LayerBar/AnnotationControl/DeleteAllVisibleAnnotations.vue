...
export default defineComponent({
  ...
  setup (props, { emit }) {
    ...
    const selectedStageInstance = computed(() => state.workview.selectedStageInstance)

    const disabledToDeleteAll = computed(() => {
      return selectedStageInstance.value && selectedStageInstance.value.type === StageType.Complete
    })
