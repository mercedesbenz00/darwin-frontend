...
import GenericFilterOption from '@/components/DatasetFiltering/GenericFilter/Common/GenericFilterOption.vue'
import GenericFilterSelectedOption from '@/components/DatasetFiltering/GenericFilter/Common/GenericFilterSelectedOption.vue'
import {
...
import { GenericFilterOptionType } from './types'
import { membershipToOption, folderToOption, filenameToOption } from './utils'
...
export default class GenericFilter extends Vue {
  ...
  toggleOption (params: { option: GenericFilterOptionType, status: TriToggleStatus }) {
  ...
  shiftToggleOption (params: { option: GenericFilterOptionType, status: TriToggleStatus }) {
    const { option, status } = params
    this.updateOptionStatus(option, status)
  }

  deselectOption (option: GenericFilterOptionType) {
    this.updateOptionStatus(option, 'none')
  }

  updateOptionStatus (option: GenericFilterOptionType, status: TriToggleStatus) {
    switch (option.type) {
    case 'assignees':
  ...
  updateAssigneeOptionStatus (data: MembershipPayload, status: TriToggleStatus) {
  ...
  updateFilenameOptionStatus (data: DatasetItemFilenamePayload, status: TriToggleStatus) {
  ...
  updateFolderOptionStatus (data: DatasetFolderPayload, status: TriToggleStatus) {
