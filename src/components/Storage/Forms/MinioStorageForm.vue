<template>
  <form @submit.prevent="onSubmit">
    ...
    <div class="storage__field-label-container">
      <div>
        <span class="storage__field-label">Base Url</span>
        <span class="field-required">*</span>
      </div>
      <info title="Base Url (Required)">
        Base URL fro MinIO server.
      </info>
    </div>
    <input-field
      id="baseUrl"
...
export default class MinioStorageForm extends Vue {
  ...
  validateForm (): boolean {
    ...
    if (isEmpty(this.baseUrl.trim())) {
      this.error.baseUrl = 'Base url cannot be empty'
    }
  ...
  onSubmit (): void {
    if (!this.validateForm()) {
      this.$ga.event('minio_storage', 'submit', 'failure_form_invalid')
      return
    }
