...
export default class GcpStorageForm extends Vue {
  ...
  onSubmit (): void {
    if (!this.validateForm()) {
      this.$ga.event('gcp_storage', 'submit', 'failure_form_invalid')
      return
    }
    this.$emit('submitted', {
