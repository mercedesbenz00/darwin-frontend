...
export default class DropdownV2 extends Vue {
  /**
  ...
  @Prop({ required: false, default: 'light', type: String as () => 'light' | 'dark' })
  theme!: 'light' | 'dark'
...
.dropdown__arrow {
  ...
  border-top: 7px solid $colorIconButtonDefault;
  border-bottom: none;
  left: auto;
  top: 55%;
  margin: 0;
...
.vs__dropdown-option {
  ...
  &.vs__dropdown-option--highlight {
    ...
    color: $colorInteractivePrimaryHover!important;
  }
