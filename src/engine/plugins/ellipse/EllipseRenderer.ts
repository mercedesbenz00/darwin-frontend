import { drawEllipse } from '@/engine/graphics'
import { LinearInterpolationParams } from '@/engine/interpolate'
import { Annotation, MainAnnotationTypeRenderer, SpecialKey, View } from '@/engine/models'
...
export class EllipseRenderer extends MainAnnotationTypeRenderer {
  ...
  translate (annotation: Annotation, offset: ImagePoint, view: IView) {
