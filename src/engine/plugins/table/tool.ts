...
export const tool: TableTool = {
  ...
  onEnd (context: ToolContext, event: CanvasEvent) {
    ...
    this.initialImagePoint = context.editor.camera.canvasViewToImageView(this.initialPoint)
    this.cursorImagePoint = context.editor.camera.canvasViewToImageView(this.cursorPoint)
  ...
  activate (context: ToolContext) {
    ...
    context.editor.setToolOptionProps('rows', { value: this.rows })
    context.editor.setToolOptionProps('cols', { value: this.cols })
    ...
    const viewsOnRender = context.editor.viewsList.map(view =>
      view.renderManager.onRender((view) => {
        ...
        const finalInitialPoint = this.initialImagePoint
          ? context.editor.camera.imageViewToCanvasView(this.initialImagePoint)
          : this.initialPoint

        const finalCursorPoint = this.cursorImagePoint
          ? context.editor.camera.imageViewToCanvasView(this.cursorImagePoint)
          : this.cursorPoint
