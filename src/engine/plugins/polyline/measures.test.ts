...
import { measures } from '@/engine/plugins/polyline/measures'
import { Polyline } from '@/engine/plugins/polyline/types'
...
beforeEach(() => {
  ...
  measureOverlayLabel = 'Length: 270.00cm'
  measureOverlayItems = [{
    center: 'HOR',
    position: expect.objectContaining({ x: 100, y: 25 }),
    value: '270.00',
    unit: 'cm'
  }]
})
