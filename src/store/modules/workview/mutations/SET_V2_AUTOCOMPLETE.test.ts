...
const instance = buildV2WorkflowStageInstancePayload({ item_id: 'item', id: 'instance' })
...
const MUTATION = 'workview/SET_V2_AUTOCOMPLETE'
beforeEach(() => {
...
it('updates item state', () => {
  ...
  expect(itemState?.current_stage_instances[0].data.scheduled_to_complete_at).not.toBe(null)
})
