...
const PAYLOAD: StoreActionPayload<typeof restartV2WorkflowItem> = undefined
const ACTION = 'workview/restartV2WorkflowItem'
...
const itemState = buildV2WorkflowItemStatePayload({
  current_stage_instances: [
    buildV2WorkflowStageInstancePayload({
      stage_id: 'foo',
      stage: buildV2WorkflowStagePayload({ name: 'Complete', type: StageType.Complete })
    })
  ]
})
