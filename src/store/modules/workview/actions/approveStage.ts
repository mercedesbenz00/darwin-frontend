...
export const approveStage: WorkviewAction<WorkflowStagePayload, WorkflowStagePayload> =
  async ({ commit, state }, stage) => {
    const params: SetStageReviewStatusParams = { stageId: stage.id, status: ReviewStatus.Approved }
